    ...
    <main class="contenedor seccion">
        ...
        <form class="formulario" method="POST" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <input type="number" id="wc" name="wc"  min="1" max="50" value="<?php echo $wc; ?>">

                <label for="estacionamiento">Estacionamiento:</label>
                <input type="number" id="estacionamiento" name="estacionamiento"  min="1" max="50" value="<?php echo $estacionamiento; ?>">
